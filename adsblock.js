! function() {
    function f() {
        ...
        a.id = "levelmaxblock";
        a.innerHTML = '<div class="inner"><div class="header"><h2 style="color:#fff;">Detected Ad Blocker</h2></div><p>Please disable your ad blocker to continue !</p><br/><p> Or please use your browser <b>Chrome</b> or <b>Firefox</b> to continue !</p></div>';
